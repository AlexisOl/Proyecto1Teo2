...
export class ComprasServicioService {
  ...
  public envioComentario(comentario: comentario): Observable<comentario> {
    return this.http.post<comentario>(this.URL + '/ingresoComentario', {
      comentario,
    });
  }
  ...
  public verPublicacionEspecificaCompras(id: number): Observable<publicacion> {
    return this.http.get<publicacion>(
      this.URL + '/obtenerInfoPublicacionCompra?id=' + id
    );
  }

  //funcion para obtener la conversacion CLIENTE
  public verConversacionCliente(
    idCliente: number | undefined,
    idPublicacion: number | undefined
  ) {
    return this.http.get<comentario>(
      this.URL +
        '/obtenerConversacionEspecifica?idCliente=' +
        idCliente +
        '&idPublicacion=' +
        idPublicacion
    );
  ...
  public insertarDetalleFactura(
    ...
    utilizacionCupon: utilizacionCupon | null
  ): Observable<detalleFactura> {
    return this.http.post<detalleFactura>(this.URL + '/ingresoDetalleFactura', {
      detalleFactura,
      utilizacionCupon,
    });
  }
  ...
  public obtenerIdFacturasTotal(id: number | undefined): Observable<factura> {
    return this.http.get<factura>(
      this.URL + '/obtenerIdFacturasTotal?id=' + id
    );
  }

  //funcion para obtener el detalle de cada factura
  public obtenerFacturasIdDetalle(
    id: number | undefined,
    idFactura: number
  ): Observable<factura> {
    return this.http.get<factura>(
      this.URL + '/obtenerFacturasDetalle?id=' + id + '&id_factura=' + idFactura
    );
  }
  ...
  public obtenerPublicacionesNombre(nombre: string): Observable<publicacion> {
    return this.http.get<publicacion>(
      this.URL + '/obtenerPublicacionesNombre?nombre=' + nombre
    );
  }
  ...
  public obtenerImagenesPorPublicaciones(id: number): Observable<producto> {
    return this.http.get<producto>(
      this.URL + '/obtenerImagenesPorPublicaciones?id=' + id
    );
  }
